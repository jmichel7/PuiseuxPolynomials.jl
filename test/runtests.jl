...
@test mytest("PuiseuxPolynomials.jl","coefficients(p,:x)","OrderedCollections.OrderedDict{Int64, Mvp{Int64, Int64}} with 5 entries:\n  0 => y⁴+4y²+6+4y⁻²+y⁻⁴\n  1 => 4y³+12y+12y⁻¹+4y⁻³\n  2 => 6y²+12+6y⁻²\n  3 => 4y+4y⁻¹\n  4 => 1")
@test mytest("PuiseuxPolynomials.jl","coefficients(p,:y)","OrderedCollections.OrderedDict{Int64, Mvp{Int64, Int64}} with 9 entries:\n  -4 => 1\n  -3 => 4x\n  -2 => 6x²+4\n  -1 => 4x³+12x\n  0  => x⁴+12x²+6\n  1  => 4x³+12x\n  2  => 6x²+4\n  3  => 4x\n  4  => 1")
