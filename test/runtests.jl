...
@test mytest("PuiseuxPolynomials.jl","repr(3x*y^-2+4)","\"let (x,y)=Monomial(:x,:y);3x*y^-2+4 end\"")
@test mytest("PuiseuxPolynomials.jl","repr(3x*y^-2+4,context=:efficient=>true)","\"Mvp_(Monomial_(:x => 1, :y => -2) => 3, Monomial_() => 4)\"")
